	...
	public static void convert(String input, String output, String mappingFile, 
	    ...
	    while ((r = Relation.parseDelimitedFrom(is))!=null) {
	    	if (++count % 10000 == 0){
	    		...
	    		System.out.println(r.getRelType());
	    		System.out.println(r.getSourceGuid());
	    		System.out.println(r.getDestGuid());
	    		printInfo = true;
	    	...
	    	for (int j=0; j < r.getMentionCount(); j++) {
	    		...
	    		if(printInfo){
	    			if(j == 0){
	    				System.out.println(rmf.getSentence());
	    				System.out.println("FEATURE COUNT: " +rmf.getFeatureCount());
